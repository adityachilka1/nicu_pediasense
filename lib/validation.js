...
export const createOrderSchema = z.object({
  patientId: z.number().int().positive('Patient ID is required'),
  category: z.enum(['medication', 'lab', 'imaging', 'diet', 'nursing', 'respiratory', 'procedure'], {
    errorMap: () => ({ message: 'Invalid order category' })
  }),
  orderType: z.enum(['one_time', 'recurring', 'prn', 'continuous'], {
    errorMap: () => ({ message: 'Invalid order type' })
  }),
  priority: z.enum(['stat', 'urgent', 'routine', 'scheduled']).default('routine'),
...
export const updateOrderSchema = z.object({
  status: z.enum(['pending', 'active', 'completed', 'discontinued', 'cancelled']).optional(),
...
export const carePlanPriorities = ['HIGH', 'MEDIUM', 'LOW', 'high', 'medium', 'low'];

export const carePlanStatuses = ['ACTIVE', 'ON_HOLD', 'COMPLETED', 'DISCONTINUED', 'ARCHIVED', 'active', 'on_hold', 'completed', 'discontinued', 'archived'];

export const carePlanItemTypes = ['TASK', 'ASSESSMENT', 'INTERVENTION', 'EDUCATION', 'MONITORING', 'CONSULTATION', 'task', 'assessment', 'intervention', 'education', 'monitoring', 'consultation'];

export const carePlanItemStatuses = ['PENDING', 'IN_PROGRESS', 'COMPLETED', 'SKIPPED', 'DEFERRED', 'pending', 'in_progress', 'completed', 'skipped', 'deferred'];
