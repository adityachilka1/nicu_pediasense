...
function createPrismaClient() {
  ...
  // For SQLite in development, use the adapter (if available)
  if (!usePostgres) {
    try {
      // Dynamic import of adapter for SQLite - may not be available in serverless
      ...
      console.warn('[Prisma] better-sqlite3 adapter not available, using default driver');
      // Fall back to default Prisma SQLite driver
    }
  } else {
